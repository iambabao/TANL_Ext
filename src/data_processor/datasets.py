...
from src.data_processor.input_example import InputFeatures, EntityType, RelationType, Entity, Relation, InputExample, CorefDocument
...
from src.utils.coreference_metrics import CorefAllMetrics
